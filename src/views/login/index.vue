  ...
  <div class="m-view-login">
    ...
    <div class="m-content" v-loading="loading">
      ...
      <div class="m-rightFrom">
        <div class="m-form">
          <div class="m-title">LESSO DEMO{{appenvZH}}</div>
          <!-- <el-input v-model="user" type="text" placeholder="用户名"></el-input> -->
          <el-autocomplete v-model="user" :fetch-suggestions="querySearch" placeholder="用户名" :trigger-on-focus="false" clearable></el-autocomplete>
          <el-input v-model="pwd" type="password" placeholder="密码" @keyup.enter.native="login"></el-input>
